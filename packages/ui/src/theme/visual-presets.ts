...
export const liquidGlassPreset: VisualPreset = {
  ...
  light: {
    ...
    divider: 'rgba(34, 24, 20, 0.08)',
    border: 'rgba(103, 75, 52, 0.18)',
  },
  dark: {
    primary: {
      main: '#0A84FF',
    ...
    accent: {
      main: 'rgba(26, 20, 18, 0.78)',
      light: 'rgba(34, 24, 20, 0.62)',
      dark: 'rgba(5, 4, 4, 0.68)',
    },
    success: '#30D158',
    warning: '#FF9F0A',
    error: '#FF453A',
    ...
    background: {
      ...
      paper: 'rgba(26, 18, 15, 0.62)',
      glass: 'rgba(26, 18, 15, 0.42)',
    },
    text: {
