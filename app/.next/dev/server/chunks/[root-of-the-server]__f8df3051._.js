...
"[project]/app/app/api/namespaces/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        const searchParams = request.nextUrl.searchParams;
        const context = searchParams.get('context');
        const namespaces = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$k8s$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchNamespaces"])(context || undefined);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(namespaces);
    } catch (error) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$api$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleK8sError"])(error, 'Namespaces');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__f8df3051._.js.map