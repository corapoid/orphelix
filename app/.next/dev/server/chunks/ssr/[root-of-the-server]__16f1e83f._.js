...
function buildTheme(preset, mode, compact = false) {
    ...
    const buttonRadius = isClassic ? 10 : compact ? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2f$dist$2f$theme$2f$design$2d$tokens$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["designTokens"].radius.sm : 10;
    const themeOptions = {
        palette: {
            mode,
            primary: {
        ...
        components: {
            ...
            MuiChip: {
                styleOverrides: {
                    root: {
                        borderRadius: isClassic ? 5 : compact ? 6 : __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2f$dist$2f$theme$2f$design$2d$tokens$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["designTokens"].radius.sm,
                        fontWeight: 600,
                        fontSize: `${0.8125 * scale}rem`,
