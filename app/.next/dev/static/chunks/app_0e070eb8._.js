...
"[project]/app/lib/hooks/use-services.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useServices() {
    _s();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useServices.useModeStore[mode]": (state)=>state.mode
    }["useServices.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useServices.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useServices.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useServices.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useServices.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useServices.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useServices.useQuery": (resolve)=>setTimeout(resolve, 300)
                    }["useServices.useQuery"]);
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockServices"])();
                }
...
_s(useServices, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
function useService(name) {
    _s1();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useService.useModeStore[mode]": (state)=>state.mode
    }["useService.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useService.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useService.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useService.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useService.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'services',
            mode,
        ...
        queryFn: {
            "useService.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useService.useQuery": (resolve)=>setTimeout(resolve, 200)
                    }["useService.useQuery"]);
                    const services = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockServices"])();
                    const service = services.find({
                        "useService.useQuery.service": (s)=>s.name === name
                    }["useService.useQuery.service"]);
...
_s1(useService, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
"[project]/app/app/components/common/table-only-resource-list.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TableOnlyResourceList({ title, resourceName, resourceNamePlural, icon: Icon, data, isLoading, error, refetch, searchPlaceholder, searchFilter, filters = [], customFilter, columns, defaultSortField, defaultSortOrder = 'asc', getRowKey, onRowClick, showClusterAlert = true, emptyStateDescription }) {
    ...
    const filteredData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TableOnlyResourceList.useMemo[filteredData]": ()=>{
            if (!data) return [];
            let filtered = data;
            ...
            if (searchQuery) {
                filtered = filtered.filter({
                    "TableOnlyResourceList.useMemo[filteredData]": (item)=>searchFilter(item, searchQuery)
                }["TableOnlyResourceList.useMemo[filteredData]"]);
            }
            return filtered;
        }
...
_s(TableOnlyResourceList, "RlKQfIpLovPQFNZQusY30IZBtXA=", false, function() {
    return [
...
_c = TableOnlyResourceList;
var _c;
__turbopack_context__.k.register(_c, "TableOnlyResourceList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$hooks$2f$use$2d$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/hooks/use-services.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$components$2f$common$2f$table$2d$only$2d$resource$2d$list$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/app/components/common/table-only-resource-list.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function ServicesPage() {
    ...
    const { data: services, isLoading, error, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$hooks$2f$use$2d$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServices"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$components$2f$common$2f$table$2d$only$2d$resource$2d$list$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableOnlyResourceList"], {
        title: "Services",
...
_s(ServicesPage, "fCsRfd0UCdxyfyqrOi5shSLbqqc=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$hooks$2f$use$2d$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServices"]
    ];
});
_c = ServicesPage;
var _c;
...
//# sourceMappingURL=app_0e070eb8._.js.map