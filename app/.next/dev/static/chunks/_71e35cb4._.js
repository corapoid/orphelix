...
"[project]/lib/hooks/use-daemonsets.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDaemonSets() {
    _s();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useDaemonSets.useModeStore[mode]": (state)=>state.mode
    }["useDaemonSets.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useDaemonSets.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useDaemonSets.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useDaemonSets.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useDaemonSets.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useDaemonSets.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useDaemonSets.useQuery": (resolve)=>setTimeout(resolve, 300)
                    }["useDaemonSets.useQuery"]);
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockDaemonSets"])();
                }
                // Real mode: fetch from API route (server-side)
                const response = await fetch(`/api/daemonsets?namespace=${encodeURIComponent(namespace)}&context=${encodeURIComponent(selectedContext?.name || '')}`);
...
_s(useDaemonSets, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
function useDaemonSet(name) {
    _s1();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useDaemonSet.useModeStore[mode]": (state)=>state.mode
    }["useDaemonSet.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useDaemonSet.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useDaemonSet.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useDaemonSet.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useDaemonSet.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'daemonset',
            name,
        ...
        queryFn: {
            "useDaemonSet.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useDaemonSet.useQuery": (resolve)=>setTimeout(resolve, 200)
                    }["useDaemonSet.useQuery"]);
                    const daemonsets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockDaemonSets"])();
                    const daemonset = daemonsets.find({
                        "useDaemonSet.useQuery.daemonset": (ds)=>ds.name === name
                    }["useDaemonSet.useQuery.daemonset"]);
                    if (!daemonset) throw new Error('DaemonSet not found');
                    return daemonset;
                }
                // Real mode: fetch from API route (server-side)
                const response = await fetch(`/api/daemonsets/${name}?namespace=${encodeURIComponent(namespace)}&context=${encodeURIComponent(selectedContext?.name || '')}`);
...
_s1(useDaemonSet, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
"[project]/app/components/daemonsets/daemonset-card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function DaemonSetCard({ daemonSet, onClick }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$resource$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResourceCard"], {
        ...
        statusBadge: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$status$2d$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatusBadge"], {
            ...
            fileName: "[project]/app/components/daemonsets/daemonset-card.tsx",
            lineNumber: 23,
            columnNumber: 20
        }, void 0),
        metrics: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_c = DaemonSetCard;
var _c;
__turbopack_context__.k.register(_c, "DaemonSetCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/daemonsets/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$daemonsets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/hooks/use-daemonsets.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$status$2d$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/common/status-badge.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$daemonsets$2f$daemonset$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/daemonsets/daemonset-card.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function DaemonSetsPage() {
    ...
    const { data: daemonsets, isLoading, error, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$daemonsets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDaemonSets"])();
    // Set filter from URL on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DaemonSetsPage.useEffect": ()=>{
    ...
    const columns = [
        {
            field: 'name',
            label: 'Name',
            render: (ds)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    variant: "body2",
                    fontWeight: "medium",
                    children: ds.name
                }, void 0, false, {
                    fileName: "[project]/app/daemonsets/page.tsx",
                    lineNumber: 35,
                    columnNumber: 9
                }, this)
        },
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$resource$2d$list$2d$view$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResourceListView"], {
        ...
        searchFilter: (ds, query)=>ds.name.toLowerCase().includes(query.toLowerCase()),
        customFilter: statusFilter ? (ds)=>ds.status === statusFilter : undefined,
        filters: [
            {
                label: 'Status',
                value: statusFilter,
        ...
        renderCard: (ds, onClick)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$daemonsets$2f$daemonset$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DaemonSetCard"], {
                daemonSet: ds,
                onClick: onClick
            }, void 0, false, {
                fileName: "[project]/app/daemonsets/page.tsx",
...
_s(DaemonSetsPage, "3FAE9ULg7SmT1656UmIhQo2eThY=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$daemonsets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDaemonSets"]
    ];
});
_c = DaemonSetsPage;
var _c;
__turbopack_context__.k.register(_c, "DaemonSetsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_71e35cb4._.js.map