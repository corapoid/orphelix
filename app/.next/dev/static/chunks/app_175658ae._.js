...
"[project]/app/lib/hooks/use-cronjobs.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useCronJobs() {
    _s();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useCronJobs.useModeStore[mode]": (state)=>state.mode
    }["useCronJobs.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useCronJobs.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useCronJobs.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useCronJobs.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useCronJobs.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useCronJobs.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useCronJobs.useQuery": (resolve)=>setTimeout(resolve, 300)
                    }["useCronJobs.useQuery"]);
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockCronJobs"])();
                }
...
_s(useCronJobs, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
function useCronJob(name) {
    _s1();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useCronJob.useModeStore[mode]": (state)=>state.mode
    }["useCronJob.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useCronJob.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useCronJob.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useCronJob.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useCronJob.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'cronjobs',
            name,
        ...
        queryFn: {
            "useCronJob.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useCronJob.useQuery": (resolve)=>setTimeout(resolve, 200)
                    }["useCronJob.useQuery"]);
                    const cronjobs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockCronJobs"])();
                    const cronjob = cronjobs.find({
                        "useCronJob.useQuery.cronjob": (cj)=>cj.name === name
                    }["useCronJob.useQuery.cronjob"]);
...
_s1(useCronJob, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
"[project]/app/app/components/cronjobs/cronjob-card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = CronJobCard;
var _c;
__turbopack_context__.k.register(_c, "CronJobCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/app/app/cronjobs/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$hooks$2f$use$2d$cronjobs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/hooks/use-cronjobs.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$components$2f$cronjobs$2f$cronjob$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/app/components/cronjobs/cronjob-card.tsx [app-client] (ecmascript)");
...
function CronJobsPage() {
    ...
    const { data: cronjobs, isLoading, error, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$hooks$2f$use$2d$cronjobs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCronJobs"])();
    const columns = [
        {
            field: 'name',
            label: 'Name',
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$components$2f$common$2f$resource$2d$list$2d$view$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResourceListView"], {
        ...
        renderCard: (cronJob, onClick)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$app$2f$components$2f$cronjobs$2f$cronjob$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CronJobCard"], {
                cronJob: cronJob,
                onClick: onClick
            }, void 0, false, {
                fileName: "[project]/app/app/cronjobs/page.tsx",
...
_s(CronJobsPage, "74akafxUrIjMbTzV1uLfAavbJGM=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$hooks$2f$use$2d$cronjobs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCronJobs"]
    ];
});
_c = CronJobsPage;
var _c;
...
//# sourceMappingURL=app_175658ae._.js.map