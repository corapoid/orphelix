...
"[project]/lib/hooks/use-statefulsets.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useStatefulSets() {
    _s();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useStatefulSets.useModeStore[mode]": (state)=>state.mode
    }["useStatefulSets.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useStatefulSets.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useStatefulSets.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useStatefulSets.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useStatefulSets.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useStatefulSets.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useStatefulSets.useQuery": (resolve)=>setTimeout(resolve, 300)
                    }["useStatefulSets.useQuery"]);
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockStatefulSets"])();
                }
                // Real mode: fetch from API route (server-side)
                const response = await fetch(`/api/statefulsets?namespace=${encodeURIComponent(namespace)}&context=${encodeURIComponent(selectedContext?.name || '')}`);
...
_s(useStatefulSets, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
function useStatefulSet(name) {
    _s1();
    const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useStatefulSet.useModeStore[mode]": (state)=>state.mode
    }["useStatefulSet.useModeStore[mode]"]);
    const namespace = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useStatefulSet.useModeStore[namespace]": (state)=>state.selectedNamespace
    }["useStatefulSet.useModeStore[namespace]"]);
    const selectedContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"])({
        "useStatefulSet.useModeStore[selectedContext]": (state)=>state.selectedContext
    }["useStatefulSet.useModeStore[selectedContext]"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'statefulset',
            name,
        ...
        queryFn: {
            "useStatefulSet.useQuery": async ()=>{
                if (mode === 'demo') {
                    await new Promise({
                        "useStatefulSet.useQuery": (resolve)=>setTimeout(resolve, 200)
                    }["useStatefulSet.useQuery"]);
                    const statefulsets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mocks$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateMockStatefulSets"])();
                    const statefulset = statefulsets.find({
                        "useStatefulSet.useQuery.statefulset": (sts)=>sts.name === name
                    }["useStatefulSet.useQuery.statefulset"]);
                    if (!statefulset) throw new Error('StatefulSet not found');
                    return statefulset;
                }
                // Real mode: fetch from API route (server-side)
                const response = await fetch(`/api/statefulsets/${name}?namespace=${encodeURIComponent(namespace)}&context=${encodeURIComponent(selectedContext?.name || '')}`);
...
_s1(useStatefulSet, "Nv2xfn4ud2QWvFtZ9G+BeGnTayo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$core$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModeStore"],
...
"[project]/app/components/common/resource-list-view.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ResourceListView({ title, resourceName, resourceNamePlural, icon: Icon, data, isLoading, error, refetch, searchPlaceholder, searchFilter, filters = [], customFilter, columns, defaultSortField, defaultSortOrder = 'asc', getRowKey, onRowClick, renderCard, showClusterAlert = true, emptyStateDescription }) {
    ...
    const searchQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$contexts$2f$search$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePageSearch"])(searchPlaceholder);
    // Auto-refresh
    ...
    const { sortedData, sortField, sortOrder, handleSort } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$table$2d$sort$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSortableTable"])(filteredData, defaultSortField, defaultSortOrder);
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$page$2d$header$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageHeader"], {
                    ...
                    fileName: "[project]/app/components/common/resource-list-view.tsx",
                    lineNumber: 144,
                    columnNumber: 9
                }, this),
...
"[project]/app/components/statefulsets/statefulset-card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function StatefulSetCard({ statefulSet, onClick }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$resource$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResourceCard"], {
        ...
        statusBadge: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$status$2d$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatusBadge"], {
            ...
            fileName: "[project]/app/components/statefulsets/statefulset-card.tsx",
            lineNumber: 23,
            columnNumber: 20
        }, void 0),
        metrics: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            variant: "h6",
                            fontWeight: 700,
                            children: statefulSet.replicas.updated
                        }, void 0, false, {
                            fileName: "[project]/app/components/statefulsets/statefulset-card.tsx",
                            lineNumber: 38,
                            columnNumber: 13
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            ...
                            children: statefulSet.serviceName || '-'
                        }, void 0, false, {
                            fileName: "[project]/app/components/statefulsets/statefulset-card.tsx",
                            lineNumber: 46,
                            columnNumber: 13
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            variant: "body2",
                            fontWeight: 600,
                            children: statefulSet.persistentVolumeClaims.length || 0
                        }, void 0, false, {
                            fileName: "[project]/app/components/statefulsets/statefulset-card.tsx",
                            lineNumber: 58,
                            columnNumber: 13
...
_c = StatefulSetCard;
var _c;
__turbopack_context__.k.register(_c, "StatefulSetCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/statefulsets/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$statefulsets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/hooks/use-statefulsets.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$status$2d$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/common/status-badge.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$resource$2d$list$2d$view$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/common/resource-list-view.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$statefulsets$2f$statefulset$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/statefulsets/statefulset-card.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function StatefulSetsPage() {
    ...
    const { data: statefulsets, isLoading, error, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$statefulsets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStatefulSets"])();
    // Set filter from URL on mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StatefulSetsPage.useEffect": ()=>{
    ...
    const columns = [
        {
            field: 'name',
            label: 'Name',
            render: (sts)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    variant: "body2",
                    fontWeight: "medium",
                    children: sts.name
                }, void 0, false, {
                    fileName: "[project]/app/statefulsets/page.tsx",
                    lineNumber: 35,
                    columnNumber: 9
                }, this)
        },
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$common$2f$resource$2d$list$2d$view$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResourceListView"], {
        title: "StatefulSets",
        ...
        searchFilter: (sts, query)=>sts.name.toLowerCase().includes(query.toLowerCase()),
        customFilter: statusFilter ? (sts)=>sts.status === statusFilter : undefined,
        filters: [
            {
                label: 'Status',
                value: statusFilter,
        ...
        renderCard: (sts, onClick)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$statefulsets$2f$statefulset$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatefulSetCard"], {
                statefulSet: sts,
                onClick: onClick
            }, void 0, false, {
                fileName: "[project]/app/statefulsets/page.tsx",
...
_s(StatefulSetsPage, "oqQtriL32waGMIvVCccJBSsOjOU=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$statefulsets$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStatefulSets"]
    ];
});
_c = StatefulSetsPage;
var _c;
__turbopack_context__.k.register(_c, "StatefulSetsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_01e56bf2._.js.map