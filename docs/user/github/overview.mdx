...
GitHub integration allows you to edit Kubernetes YAML files and create Pull Requests directly from KubeVista, following GitOps best practices.
...
<Info>
  KubeVista can automatically find the correct YAML file for each deployment using AI-powered matching
</Info>
...
<Steps>
  ...
  <Step title="Automatic PR">
    KubeVista creates a PR with your changes
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="What if my repo uses Kustomize?">
    KubeVista automatically detects Kustomize structure and shows base + overlay files in separate tabs.
  </Accordion>
</AccordionGroup>
