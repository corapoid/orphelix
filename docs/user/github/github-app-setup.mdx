...
This guide explains how to create and configure a GitHub App for KubeVista.
...
|-------|-------|-------------|
| **GitHub App name** | `KubeVista` (or any unique name) | Display name for the app |
| **Homepage URL** | `http://localhost:3000` | Your KubeVista URL |
...
<Warning>
  Make sure to **uncheck** the "Active" checkbox under Webhook settings - KubeVista doesn't use webhooks.
</Warning>
...
You need three credentials to configure KubeVista:
...
Create or update `.env.local` in your KubeVista project root:
...
<Steps>
  ...
  <Step title="Open Settings">
    Navigate to Settings page in KubeVista
  </Step>
