...
View full changelog: https://github.com/yourusername/orphelix/releases/tag/v1.3.0
...
```
https://github.com/yourusername/orphelix/releases/latest
```
...
<CardGroup cols={2}>
  <Card title="Changelog" icon="list" href="https://github.com/yourusername/orphelix/blob/main/CHANGELOG.md">
    View all version history
  </Card>
  <Card title="Releases" icon="tag" href="https://github.com/yourusername/orphelix/releases">
