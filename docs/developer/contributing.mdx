...
<Note>
Before contributing, please read our [Code of Conduct](https://github.com/dmakowski/orphelix/blob/main/CODE_OF_CONDUCT.md).
</Note>
...
<Steps>
  <Step title="Fork repository">
    Click "Fork" on [GitHub](https://github.com/dmakowski/orphelix)
  </Step>
  ...
  <Step title="Add upstream remote">
    ```bash
    git remote add upstream https://github.com/dmakowski/orphelix.git
    git fetch upstream
    ```
  </Step>
...
<Tabs>
  <Tab title="Good First Issues">
    Look for issues labeled [`good first issue`](https://github.com/dmakowski/orphelix/labels/good%20first%20issue)
  ...
  <Tab title="Help Wanted">
    Check [`help wanted`](https://github.com/dmakowski/orphelix/labels/help%20wanted) label
  ...
  <Tab title="Propose New Feature">
    ...
    1. Go to [Discussions](https://github.com/dmakowski/orphelix/discussions)
...
<AccordionGroup>
  <Accordion icon="question" title="I have a question">
    Ask in [GitHub Discussions](https://github.com/dmakowski/orphelix/discussions)
  </Accordion>

  <Accordion icon="bug" title="I found a bug">
    Create an [issue](https://github.com/dmakowski/orphelix/issues/new)
  </Accordion>

  <Accordion icon="lightbulb" title="I have an idea">
    Start a [discussion](https://github.com/dmakowski/orphelix/discussions/new)
  </Accordion>
...
- [CONTRIBUTORS.md](https://github.com/dmakowski/orphelix/blob/main/CONTRIBUTORS.md)
...
<Note>
Questions? Ask in [GitHub Discussions](https://github.com/dmakowski/orphelix/discussions) or create an [issue](https://github.com/dmakowski/orphelix/issues).
</Note>
