...
description: 'Technical overview for developers contributing to KubeVista'
---
...
KubeVista follows a modern, scalable architecture:
...
<CardGroup cols={2}>
  ...
  <Card title="I want to deploy KubeVista" icon="rocket" href="/developer/deployment">
